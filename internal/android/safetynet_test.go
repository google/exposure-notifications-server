...
func TestValidateAttestation(t *testing.T) {
	...
	generateTimeS := int64(1589149682123) / 1000
	...
	tests := []struct {
		...
		},
		{
			...
			false,
			"attestation is too old, must be newer than 1589149742, was 1589149682",
		},
		{
			VerifyOpts{
				AppPkgName:      appPackage,
			...
			false,
			"attestation is in the future, must be older than 1589149622, was 1589149682",
		},
	}
