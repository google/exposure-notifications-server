...
func TestVerifyAttestation(t *testing.T) {
	...
	pub := &model.Publish{
		Keys: []model.ExposureKey{
			{"zdCW5HrOKbirxmQVc0L/eA", 1, 1}, // TODO - udpate w/ real test data.
			{"t+k51ifogJo9jq3GH9LWGQ", 1, 1},
			{"3uXRrSlcv1+OMI3oFtdaUw", 1, 1},
		},
		TransmissionRisk:          1,
	...
	expectedNonce := NewNonce(pub).Nonce()
...
func TestValidateAttestation(t *testing.T) {
	...
	/* TODO(mikehelmick) : update this when we have device data.
	ttKeys := []string{
