...
type ExposureKey struct {
	...
	IntervalNumber uint32 `protobuf:"varint,2,opt,name=intervalNumber,proto3" json:"intervalNumber,omitempty"` // required
	IntervalCount  uint32 `protobuf:"varint,3,opt,name=intervalCount,proto3" json:"intervalCount,omitempty"`   // required
}
...
func (x *ExposureKey) GetIntervalNumber() uint32 {
	if x != nil {
...
func (x *ExposureKey) GetIntervalCount() uint32 {
	if x != nil {
...
var file_internal_pb_federation_proto_rawDesc = []byte{
	...
	0x6c, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x69,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x43, 0x6f,
