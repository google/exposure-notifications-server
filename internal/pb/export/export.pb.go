...
type TemporaryExposureKey struct {
	...
	// Number of intervals in period
	RollingPeriod *int32 `protobuf:"varint,4,opt,name=rolling_period,json=rollingPeriod,def=144" json:"rolling_period,omitempty"` // defaults to 10 min intervals
}
...
var file_internal_pb_export_export_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x6b, 0x65, 0x79, 0x73, 0x22, 0xc6, 0x01, 0x0a, 0x0d, 0x53, 0x69, 0x67, 0x6e, 0x61,
	...
	0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4b, 0x65, 0x79, 0x49, 0x64, 0x22,
	...
	0x6c, 0x69, 0x6e, 0x67, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x42, 0x1b, 0x5a, 0x19, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x62, 0x2f, 0x65, 0x78, 0x70, 0x6f, 0x72, 0x74,
	0x3b, 0x65, 0x78, 0x70, 0x6f, 0x72, 0x74,
}
...
var file_internal_pb_export_export_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
