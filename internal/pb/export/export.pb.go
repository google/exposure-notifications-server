...
type TemporaryExposureKey_VaccineType int32

const (
	TemporaryExposureKey_UNKNOWN_VACCINE   TemporaryExposureKey_VaccineType = 0
	TemporaryExposureKey_RNA               TemporaryExposureKey_VaccineType = 1
	TemporaryExposureKey_VIRAL_VECTOR      TemporaryExposureKey_VaccineType = 2
	TemporaryExposureKey_INACTIVATED_VIRUS TemporaryExposureKey_VaccineType = 3
	TemporaryExposureKey_PROTEIN_BASED     TemporaryExposureKey_VaccineType = 4
)

// Enum value maps for TemporaryExposureKey_VaccineType.
var (
	TemporaryExposureKey_VaccineType_name = map[int32]string{
		0: "UNKNOWN_VACCINE",
		1: "RNA",
		2: "VIRAL_VECTOR",
		3: "INACTIVATED_VIRUS",
	...
	TemporaryExposureKey_VaccineType_value = map[string]int32{
		"UNKNOWN_VACCINE":   0,
		"RNA":               1,
		"VIRAL_VECTOR":      2,
		"INACTIVATED_VIRUS": 3,
...
func (x TemporaryExposureKey_VaccineType) Enum() *TemporaryExposureKey_VaccineType {
	p := new(TemporaryExposureKey_VaccineType)
	*p = x
	return p
}

func (x TemporaryExposureKey_VaccineType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TemporaryExposureKey_VaccineType) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_pb_export_export_proto_enumTypes[1].Descriptor()
}

func (TemporaryExposureKey_VaccineType) Type() protoreflect.EnumType {
	return &file_internal_pb_export_export_proto_enumTypes[1]
}

func (x TemporaryExposureKey_VaccineType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *TemporaryExposureKey_VaccineType) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = TemporaryExposureKey_VaccineType(num)
	return nil
}

// Deprecated: Use TemporaryExposureKey_VaccineType.Descriptor instead.
func (TemporaryExposureKey_VaccineType) EnumDescriptor() ([]byte, []int) {
	return file_internal_pb_export_export_proto_rawDescGZIP(), []int{2, 1}
}
...
type TemporaryExposureKey struct {
	...
	// If true, these keys come from a vacinnated user.
	Vaccinated               *bool                             `protobuf:"varint,7,opt,name=vaccinated" json:"vaccinated,omitempty"`
	VaccineType              *TemporaryExposureKey_VaccineType `protobuf:"varint,8,opt,name=vaccine_type,json=vaccineType,enum=TemporaryExposureKey_VaccineType" json:"vaccine_type,omitempty"`
	VaccinationComplete      *bool                             `protobuf:"varint,9,opt,name=vaccination_complete,json=vaccinationComplete" json:"vaccination_complete,omitempty"`
	DaysSinceLastVaccination *int32                            `protobuf:"zigzag32,10,opt,name=days_since_last_vaccination,json=daysSinceLastVaccination" json:"days_since_last_vaccination,omitempty"`
}
...
func (x *TemporaryExposureKey) GetVaccinated() bool {
...
func (x *TemporaryExposureKey) GetVaccineType() TemporaryExposureKey_VaccineType {
	if x != nil && x.VaccineType != nil {
		return *x.VaccineType
	}
	return TemporaryExposureKey_UNKNOWN_VACCINE
}

func (x *TemporaryExposureKey) GetVaccinationComplete() bool {
	if x != nil && x.VaccinationComplete != nil {
		return *x.VaccinationComplete
	}
	return false
}

func (x *TemporaryExposureKey) GetDaysSinceLastVaccination() int32 {
	if x != nil && x.DaysSinceLastVaccination != nil {
		return *x.DaysSinceLastVaccination
	}
	return 0
}
...
var file_internal_pb_export_export_proto_rawDesc = []byte{
	...
	0x64, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x22, 0x9e, 0x06, 0x0a, 0x14, 0x54, 0x65,
	...
	,
...
var file_internal_pb_export_export_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_internal_pb_export_export_proto_goTypes = []interface{}{
	...
	(TemporaryExposureKey_VaccineType)(0), // 1: TemporaryExposureKey.VaccineType
	(*TemporaryExposureKeyExport)(nil),    // 2: TemporaryExposureKeyExport
	(*SignatureInfo)(nil),                 // 3: SignatureInfo
	(*TemporaryExposureKey)(nil),          // 4: TemporaryExposureKey
	(*TEKSignatureList)(nil),              // 5: TEKSignatureList
	(*TEKSignature)(nil),                  // 6: TEKSignature
}
var file_internal_pb_export_export_proto_depIdxs = []int32{
	3, // 0: TemporaryExposureKeyExport.signature_infos:type_name -> SignatureInfo
	4, // 1: TemporaryExposureKeyExport.keys:type_name -> TemporaryExposureKey
	4, // 2: TemporaryExposureKeyExport.revised_keys:type_name -> TemporaryExposureKey
	0, // 3: TemporaryExposureKey.report_type:type_name -> TemporaryExposureKey.ReportType
	1, // 4: TemporaryExposureKey.vaccine_type:type_name -> TemporaryExposureKey.VaccineType
	6, // 5: TEKSignatureList.signatures:type_name -> TEKSignature
	3, // 6: TEKSignature.signature_info:type_name -> SignatureInfo
