...
type TemporaryExposureKey struct {
	...
	RollingStartIntervalNumber *uint32 `protobuf:"varint,3,opt,name=rolling_start_interval_number,json=rollingStartIntervalNumber" json:"rolling_start_interval_number,omitempty"`
	// Increments of 10 minutes describing how long a key is valid
	RollingPeriod *uint32 `protobuf:"varint,4,opt,name=rolling_period,json=rollingPeriod,def=144" json:"rolling_period,omitempty"` // defaults to 24 hours
}

// Default values for TemporaryExposureKey fields.
const (
	Default_TemporaryExposureKey_RollingPeriod = uint32(144)
)
...
func (x *TemporaryExposureKey) GetRollingStartIntervalNumber() uint32 {
...
func (x *TemporaryExposureKey) GetRollingPeriod() uint32 {
...
var file_internal_pb_export_export_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x3a, 0x03, 0x31, 0x34, 0x34, 0x52, 0x0d, 0x72, 0x6f,
