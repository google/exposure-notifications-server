...
type Environment struct {
	...
	SSLCertPath        string        `envconfig:"DB_SSLCERT" secretfile:"true"`
	SSLKeyPath         string        `envconfig:"DB_SSLKEY" secretfile:"true"`
	SSLRootCertPath    string        `envconfig:"DB_SSLROOTCERT" secretfile:"true"`
