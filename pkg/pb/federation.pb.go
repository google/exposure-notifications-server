...
type ContactTracingResponse struct {
	...
	RegionIdentifier string          `protobuf:"bytes,2,opt,name=regionIdentifier,proto3" json:"regionIdentifier,omitempty"`                     // required
	DiagnosisKeys    []*DiagnosisKey `protobuf:"bytes,3,rep,name=diagnosisKeys,proto3" json:"diagnosisKeys,omitempty"`
}
...
func (x *ContactTracingResponse) GetDiagnosisStatus() DiagnosisStatus {
	if x != nil {
...
func (x *ContactTracingResponse) GetRegionIdentifier() string {
	if x != nil {
		return x.RegionIdentifier
	}
	return ""
}

func (x *ContactTracingResponse) GetDiagnosisKeys() []*DiagnosisKey {
	if x != nil {
...
type DiagnosisKey struct {
	...
	Timestamp    int64  `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"`      // required
}
...
func (x *DiagnosisKey) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_pkg_pb_federation_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xb5, 0x01, 0x0a, 0x16, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x63,
	...
	,
	...
	0x48, 0x0a, 0x0f, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x69, 0x73, 0x53, 0x74, 0x61, 0x74,
...
var file_pkg_pb_federation_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_pb_federation_proto_goTypes = []interface{}{
	...
	(*DiagnosisKey)(nil),            // 4: DiagnosisKey
}
var file_pkg_pb_federation_proto_depIdxs = []int32{
	3, // 0: FederationFetchResponse.response:type_name -> ContactTracingResponse
	0, // 1: ContactTracingResponse.diagnosisStatus:type_name -> DiagnosisStatus
	4, // 2: ContactTracingResponse.diagnosisKeys:type_name -> DiagnosisKey
	1, // 3: Federation.Fetch:input_type -> FederationFetchRequest
	2, // 4: Federation.Fetch:output_type -> FederationFetchResponse
