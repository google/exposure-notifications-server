...
func (x *DiagnosisKeyExport_DiagnosisKey) GetIntervalNumber() int32 {
	if x != nil {
...
func (x *DiagnosisKeyExport_DiagnosisKey) GetIntervalCount() int32 {
	if x != nil {
...
var file_pkg_pb_export_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x05, 0x52, 0x0e, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x4e, 0x75, 0x6d,
